...
const { createNote,getAllNotes ,getNoteById,updateNote,replaceNote , deleteNote,createBulkNotes,deleteNote,deleteBulkNotes,getNotesByCategory,getNotesByStatus,getNoteSummary,filterNotes,filterPinnedNotes,filterCategoryNotes,filterNotesByDateRange} = require('../controllers/note.controller');
